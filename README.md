...
## Config
See the [config](docs/config.md) page for detailed information on editing the config.

The [defaults](docs/defaults.md) page highlights what default config values the mod starts out with, including what biomes they spawn in and their weights. 
