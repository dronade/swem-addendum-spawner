...
- For most players this will be in your Minecraft instances' `config` folder on the computer you run the game from. The file is named `addendumspawner-common.toml`. Edit this file locally and keep a backup before changing anything.
